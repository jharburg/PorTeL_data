...
%% load data
%testing integral term 0.4, 0.2

%star
% track_FSM = readmatrix("FSM_CLtrack_20221018_191341.30.csv");

%star
% track_FSM = readmatrix("FSM_CLtrack_20221018_191548.45.csv");

%star
% track_FSM = readmatrix("FSM_CLtrack_20221018_192544.62.csv");

%YAOGAN 1,
% track_TLE = readmatrix("TLE_track_20221018_193324.80.csv");
% track_FSM = readmatrix("FSM_CLtrack_20221018_193551.04.csv");

%Cosmos 1898 Rocket
track_TLE = readmatrix("TLE_track_20221018_195247.56.csv");
track_FSM = readmatrix("FSM_CLtrack_20221018_200003.19.csv");

%ATLAS 2AS CENTAUR R/B, fail
% track_TLE = readmatrix("TLE_track_20221018_200643.97.csv");
% track_FSM = readmatrix("FSM_CLtrack_20221018_200956.21.csv");

%Cosmos 2278 Rocket, 3 tries was dim
% track_TLE = readmatrix("TLE_track_20221018_201346.58.csv");
% track_FSM = readmatrix("FSM_CLtrack_20221018_201622.95.csv");

%star
% track_FSM = readmatrix("FSM_CLtrack_20221018_202058.71.csv");

%Cosmos 1943 Rocket, brief track
% track_TLE = readmatrix("TLE_track_20221018_203521.15.csv");
% track_FSM = readmatrix("FSM_CLtrack_20221018_204322.22.csv");
