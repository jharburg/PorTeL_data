...
%apex
% track_TLE = readmatrix("TLE_track_20221020_190242.01.csv");
% track_FSM = readmatrix("FSM_CLtrack_20221020_190303.31.csv");

%Cosmos 1300
% track_TLE = readmatrix("TLE_track_20221020_191429.02.csv");
% track_FSM = readmatrix("FSM_CLtrack_20221020_191950.44.csv");

%Cosmos 1943 Rocket
track_TLE = readmatrix("TLE_track_20221020_195531.00.csv");
track_FSM = readmatrix("FSM_CLtrack_20221020_200527.45.csv");

%?
% track_FSM = readmatrix("FSM_CLtrack_20221020_203809.40.csv");
