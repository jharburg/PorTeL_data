...
%% load data
%gains 0.3, no integral term 

%track ISS
% track_TLE = readmatrix("TLE_track_20220916_195906.03.csv");
% track_FSM = readmatrix("FSM_CLtrack_20220916_200058.82.csv");

%SJ-6B
% track_TLE = readmatrix("TLE_track_20220916_201819.19.csv");
% track_FSM = readmatrix("FSM_CLtrack_20220916_202029.60.csv");

%Resurs 01 Rocket
% track_TLE = readmatrix("TLE_track_20220916_210301.33.csv");
% track_FSM = readmatrix("FSM_CLtrack_20220916_210559.60.csv"); %empty

%Resurs 01 Rocket
% track_TLE = readmatrix("TLE_track_20220916_210709.22.csv");
% track_FSM = readmatrix("FSM_CLtrack_20220916_210826.49.csv");

%ISS
% track_TLE = readmatrix("TLE_track_20220916_211308.26.csv");
% track_FSM = readmatrix("FSM_CLtrack_20220916_211737.44.csv");
