...
%% load data
% integral term 0.4, 0.2, opr 9

%CLICK, first light
track_TLE = readmatrix("TLE_track_20221128_193147.23.csv");
track_FSM = readmatrix("FSM_CLtrack_20221128_193833.26.csv");
%% plot TLE
t = track_TLE(:,1)-track_TLE(1,1);  %time relative to start of pass
% t = datxetime(track_TLE(:,1),'ConvertFrom','posixtime');
...
% ylim([-100,100])
hold on
plot([0,6],[-21.75,21.75;-21.75,21.75],'k--')
hold off
legend('x','y','Requirement')
